...
from app.service import QueryWeaverService
...
class QueryWeaverServiceTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        seed_demo_data(database_dir=self.database_root / "demo_mock")
        config = Settings(
            api_key="",
        ...
        self.service = QueryWeaverService(client, index)  # type: ignore[arg-type]
        self.client = client
    ...
    def test_sql_model_failure_is_returned_without_template_fallback(self) -> None:
        ...
        service = QueryWeaverService(client, index)  # type: ignore[arg-type]
