...
class McpRuntimeTest(unittest.TestCase):
    def setUp(self) -> None:
        ...
        seed_demo_data(database_dir=database_root / "demo_mock")
    ...
    def test_tool_list_contains_schema_and_one_tool_per_database(self) -> None:
        ...
        database_tool = by_name["query_demo_mock"]
    ...
    def test_database_tool_executes_read_only_sql(self) -> None:
        ...
        self.assertEqual(result["database"], "demo_mock")
    ...
    def test_database_tool_is_hidden_for_user_without_database_access(self) -> None:
        ...
        self.assertNotIn("query_demo_mock", names)
        with self.assertRaises(RuntimeError):
            client.call_tool("query_demo_mock", {"sql": "SELECT order_id FROM orders_current"})
    ...
    def test_execution_rechecks_table_permission_inside_cte(self) -> None:
        scope = AccessScope(
            ...
            roles=("test",),
            allowed_databases=frozenset({"demo_mock"}),
